...
public class FloatWindowManager {
    ...
    private final TextureView mainTextureView;
    private final Button closeButton;
    private boolean isWindowOpen;
    private final int windowSizeInDp = 80;
    ...
    public FloatWindowManager(Context context, TextureView mainTextureView) {
        ...
        closeButton.setText("ToP");
        floatView.addView(closeButton, new FrameLayout.LayoutParams(
                FrameLayout.LayoutParams.WRAP_CONTENT,
                FrameLayout.LayoutParams.WRAP_CONTENT,
                Gravity.BOTTOM | Gravity.CENTER_HORIZONTAL
        ));
        floatView.setBackgroundResource(R.drawable.icon_taiji);
        isWindowOpen = false;
        closeButton.setOnClickListener(v -> {
            Intent intent = new Intent(context, RawAudioDataActivity.class);
